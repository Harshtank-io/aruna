...
export function ScoutingDrawer({
  ...
  return (
    <aside className="flex h-full w-full max-w-md flex-col border-l border-line bg-paper">
      <header className="shrink-0 border-b border-line px-5 py-4">
        <p className="label-caps text-accent">Scouting</p>
        <h2 className="font-display mt-1 text-2xl text-ink">Location brief</h2>
        <p className="mt-1 text-sm text-ink-soft">
          Type a place — the map moves live. Pick tags, then Generate for photos
          and the AI briefing.
        </p>
      </header>
